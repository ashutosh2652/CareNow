...
import { AdminBlogCard } from "../components/Admin/BlogCard";
...
export default function AdminBlog() {
	...
	return (
		<div className='overflow-y-auto min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white font-sans selection:bg-indigo-500/30 relative overflow-hidden'>
			...
			<div className='absolute inset-0 overflow-hidden pointer-events-none'>
				...
				<div className='absolute -bottom-40 -left-40 w-80 h-80 bg-fuchsia-500/5 rounded-full blur-3xl animate-pulse delay-700'></div>
				<div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl animate-pulse delay-1000'></div>
			</div>
					...
					>
						...
						<div className='container mx-auto px-6 py-16 md:py-24'>
							...
							>
								...
								<h1 className='text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-white via-indigo-100 to-white bg-clip-text text-transparent mb-6'>
							...
							<motion.div
								...
								className='mb-12'
							>
								<div className='max-w-4xl mx-auto bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-slate-700/40 shadow-2xl'>
									<div className='flex flex-col md:flex-row gap-6 items-center'>
										...
										<div className='flex-1 relative'>
											<input
												...
												className='w-full px-6 py-4 bg-slate-800/60 border border-slate-600/60 rounded-2xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-400/50 transition-all duration-300 text-white placeholder-slate-400 backdrop-blur-sm'
											/>
