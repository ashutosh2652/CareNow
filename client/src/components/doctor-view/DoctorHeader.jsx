...
const navLinks = [
	{ text: "Home", url: "/doctor" },
	{ text: "Appointment", url: "/doctor/appointment" },
	{ text: "Blog", url: "/doctor/blog" },
	{ text: "Contact", url: "/doctor/contact" },
	{ text: "About Us", url: "/doctor/about" },
];
		...
		>
			<div className='max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='flex items-center justify-between h-20'>
					<NavLink to='/doctor' className='flex items-center'>
